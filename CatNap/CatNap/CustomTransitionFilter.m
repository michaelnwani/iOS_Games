...
-(CIImage *)outputImage
{
    ...
    [color setValue:[CIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:self.inputTime] forKey:@"inputColor"];
    ...
    [blendWithMask setValue:self.inputImage forKey:@"inputBackgroundImage"];
    [blendWithMask setValue:self.inputTargetImage forKey:@"inputImage"];
